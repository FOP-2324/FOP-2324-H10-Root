 ...
 * @see MySet
 */
public class DecoratorSet<T> extends MySet<T> implements Iterable<T> {
    ...
    /**
     * Delegate the given operation to the underlying set. If the result is an {@link MySetInPlace}, the head of this
     * set is overridden with the head of the underlying set.
     *
     * @param operation the operation to delegate
     * @param <R>       the type of the result
     * @return the result of the function
     */
    protected <R> MySet<R> delegate(Function<MySet<T>, MySet<R>> operation) {
        MySet<R> result = operation.apply(underlying);
